...
<style>
    ...
    * { font-family: 'Pretendard', sans-serif !important; }
    ...
    .stButton > button:hover { background-color: #2b6ed9 !important; }
...
if not st.session_state.logged_in:
    ...
    with col2:
        admin_pw = os.environ.get("ADMIN_PASSWORD") or st.secrets.get("ADMIN_PASSWORD", "jjcompany123")
...
# ==========================================
# [모드 C] B2B 관제탑 (V5.2 오리지널 6탭 완전 복원)
# ==========================================
st.title("🛡️ 제이제이컴퍼니 관제탑 V5.2 (PRO B2B 마케터 에디션)")
st.markdown("**충남 금산군** | 스티로폼·아이스팩·프레시박스·야자매트·PE타포린 | **대전/충청권 B2B 당일 배송**")
st.write("---")
